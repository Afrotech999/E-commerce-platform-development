...
import { Plus, Edit, Trash2, Package, TrendingUp, DollarSign, Users, Image, LayoutGrid, Tag, ChevronDown, ChevronRight, ArrowLeft, Eye } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v); if (v !== 'products') setCategoryFilter(null); }} className="space-y-6">
                            ...
                            return cat ? (
                                <div className="flex items-center gap-3 bg-gradient-to-r from-gray-50 to-white border border-gray-200 rounded-xl px-4 py-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-semibold text-gray-900">Showing products in: <span className="text-black">{cat.name}</span></p>
                                                        ...
                                                        <TableCell>
                                                            <div className="flex flex-col gap-0.5">
                                                                <span className="font-semibold text-gray-900">
                                                                    Birr {Number(product.price || 0).toFixed(2)}
                                                                </span>
                    ...
                    <TabsContent value="categories" className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                            {categories.map((c) => {
                                ...
                                const totalValue = categoryProducts.reduce((sum, p) => sum + Number(p.price || 0), 0);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">Shown in the product details list.</p>
                                ...
                                {/* Price + Original Price + Stock + Brand + Category */}
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                    ...
                                    <div>
                                        <Label htmlFor="originalPrice">Original Price <span className="text-gray-400 font-normal">(optional)</span></Label>
                                        <Input
                                            id="originalPrice"
                                            type="number"
                                            step="0.01"
                                        ...
                                        {formData.originalPrice && formData.price && parseFloat(formData.originalPrice) > parseFloat(formData.price) ? (
                                            ...
                                            <p className="mt-1 text-xs text-amber-600">
                                                ⚠️ Original price should be higher than selling price to show a discount.
                                            </p>
                                        ) : (
                                            <p className="mt-1 text-xs text-gray-500">
                                                Set higher than selling price to show a strikethrough discount.
                                            </p>
                                        )}
                                    </div>
                                ...
                                <div>
                                    ...
                                    <p className="mt-1.5 text-xs text-gray-400">
                                        Used products appear in the "Used Products" section on the home page and Used page.
                                    </p>
                                </div>
